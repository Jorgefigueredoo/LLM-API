    ...
    public String gerarDicaDeSaude(String cidade, String estado) {
        String prompt = String.format(
                """
                        ...
                        Escreva uma parágrafo curto (de no máximo 3 linhas)
                        com uma dica de saúde para um paciente que more em %s - %s,
                        levando em consideração o clima dessa região. Seja cordial.
                        """, cidade, estado);
